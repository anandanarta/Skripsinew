...
<?php include_once 'header.php'; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Pengaturan Systematic Sampling
        <small></small>
      </h1>
    </section>
      ...
      <form action="uploadmetodepref.php" method="post" enctype="multipart/form-data">
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Pengaturan Tipe Sistematik</h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-4">
                  <label for="sel-circular">Pilih Tipe Sistematik</label>
                  <select name="circular" id="sel-circular" class="form-control" data-placeholder="Pilih Salah Satu Variabel ID" required style="width: 100%;">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Pemilihan Variabel Penarikan Sampel</h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-4">
                  <label for="sel-var_order">Pilih Variabel Pengurutan</label>
                  <select multiple name="var_order[]" id="sel-var_order" data-placeholder="Pilih Variabel Sesuai Urutan Pengurutan" class="form-control selectpicker" required style="width: 100%;">
                    <?php include 'list_var.php' ?>
                  </select>
              </div>
            </div>
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-md-4">
                  <label for="input_jumlah">Jumlah Sampel per ID Unit</label>
