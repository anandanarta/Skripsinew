      ...
      <form action="uploadmetodepref.php" method="post" enctype="multipart/form-data">
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-md-4">
                  <label for="sel-var_size">Pilih Variabel Size</label>
                  <select name="var_size" id="sel-var_size" data-placeholder="Pilih Variabel Size" class="form-control selectpicker" required style="width: 100%;">
                    <?php include 'list_var.php' ?>
                  </select>
              </div>
            </div>
